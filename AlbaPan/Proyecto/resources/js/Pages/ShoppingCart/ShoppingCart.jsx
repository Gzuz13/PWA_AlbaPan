    ...
    return (
        <Layout>
            ...
            <div className="container relative">
                <div className="carrito-container space-y-4 max-w-4xl mx-auto">
                    <SectionList title="Carrito de compra">
                        {/* <TitleContent text={"Carrito de compra (" + cartProducts.cardProducts.length + ")"} /> */}
                        <div className=" carrito-container divide-y divide-gray-200">
                        ...
                        {cardProducts.length ? (
                            <>
                                ...
                                <div className=" text-right mt-6 ">
                                    <PrimaryButton className="button" onClick={handleClickCheckout} isLoading={processing} disabled={processing}>Comprar ahora</PrimaryButton>
                                </div>
                            </>
                        ) : (
