...
Route::get('/conocenos', function () {
    return Inertia::render('AlbaPan/Conocenos'); // Asegúrate de que esta sea la ruta correcta del componente
})->name('conocenos');

Route::get('/welcome', function () {
    return Inertia::render('AlbaPan/Welcome'); // Cambiado a 'Welcome' si este es el nombre del componente
})->name('welcome');
